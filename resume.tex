...
% \definecolor{awesome}{HTML}{123456}
...
\name{Bailin}{Li}
%\position{Reverse Engineer{\enskip\cdotp\enskip}Vulnerability Researcher}

% \address{}

\mobile{98636166}
\email{bailinx@hotmail.com}
\homepage{www.rootkiddie.com}
\github{rootkie}
\linkedin{li-bailin}
% \gitlab{gitlab-id}
